...
router.route("/shop").get(authMiddleware.authenticateToken,userController.getShopPage);

router.route("/shop/:imageid").put(authMiddleware.authenticateToken,userController.Shoppping);

router.route("/shop/:equip/:imageid").put(authMiddleware.authenticateToken,userController.equipProfileFrame);
...
router.route("/dashboard/profileupdate").post(authMiddleware.authenticateToken,userController.profileUpdate);
